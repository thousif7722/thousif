...
export const apiService = {
  ...
  getCompanyConfig: () => api.get('/company/config'),
  updateCompanyConfig: (data) => api.put('/company/config', data),
  getOrgChart: () => api.get('/company/org-chart'),
  getCompanyRoles: () => api.get('/company/roles'),
  createCompanyRole: (data) => api.post('/company/roles', data),
  getCompanyDepartments: () => api.get('/company/departments'),
  createCompanyDepartment: (data) => api.post('/company/departments', data),
  updateCompanyDepartment: (id, data) => api.put(`/company/departments/${id}`, data),
  getCompanyTeams: () => api.get('/company/teams'),
  createCompanyTeam: (data) => api.post('/company/teams', data),
  transferCompanyMember: (data) => api.post('/company/teams/transfer', data),
  getCompanyTargets: () => api.get('/company/targets'),
  createCompanyTarget: (data) => api.post('/company/targets', data),
  updateCompanyTarget: (id, data) => api.put(`/company/targets/${id}`, data),
  getCompanyTasks: (params) => api.get('/company/tasks', { params }),
  createCompanyTask: (data) => api.post('/company/tasks', data),
  updateCompanyTask: (id, data) => api.put(`/company/tasks/${id}`, data),
  getCompanyAnnouncements: () => api.get('/company/announcements'),
  createCompanyAnnouncement: (data) => api.post('/company/announcements', data),
  getCompanyMeetings: () => api.get('/company/meetings'),
  createCompanyMeeting: (data) => api.post('/company/meetings', data),
  getCompanyChat: (params) => api.get('/company/chat', { params }),
  sendCompanyChat: (data) => api.post('/company/chat', data),
  getCompanyAttendance: () => api.get('/company/attendance'),
  markCompanyAttendance: () => api.post('/company/attendance/check'),
  getCompanyRequests: () => api.get('/company/requests'),
  createCompanyRequest: (data) => api.post('/company/requests', data),
  actionCompanyRequest: (id, data) => api.put(`/company/requests/${id}/action`, data),
  getCompanyAuditLogs: () => api.get('/company/audit-logs'),
